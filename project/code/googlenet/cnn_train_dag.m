...
opts.augmentation.cropping = 0.0;
opts.augmentation.rotation = 0.0;
opts.augmentation.illumChanges   = 0.0;
...
for t=1:opts.batchSize:numel(subset)
  ...
  for s=1:opts.numSubBatches
    ...
    if strcmp(mode, 'train')
      net.mode = 'normal' ;
%      net.vars(net.getVarIndex('label')).precious = true;
      net.accumulateParamDers = (s ~= 1) ;
      net.eval(inputs, opts.derOutputs) ;
         
%      net.vars(net.getVarIndex('label')).value
    else
      net.mode = 'test' ;
      net.eval(inputs) ;
    end
