...
opts.augmentation.flipping = 0.0; % default no augmentation
opts.augmentation.cropping = 0.0; % default no augmentation
opts.augmentation.illumChanges = 0.0; % default no augmentation
opts.augmentation.rotation = 0.0; % default no augmentation
...
if training, mode = 'normal' ; else, mode = 'test' ; end
